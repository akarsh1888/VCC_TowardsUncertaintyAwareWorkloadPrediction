...
def plot_series(
    series, series2, start=0, end=None, label1="", label2="", title="output"
):
    plt.figure(figsize=(10, 6))
...
def plot_series_interval(
    series, series2, std, start=0, end=None, label1="", label2="", title="output"
):
...
def plot_bayes_series(
    series, series2, min, max, start=0, end=None, label1="", label2="", title="output"
):
    plt.figure(figsize=(20, 10))
    plt.plot(series[start:end], label=label1)
    plt.plot(series2[start:end], "o", label=label2)
