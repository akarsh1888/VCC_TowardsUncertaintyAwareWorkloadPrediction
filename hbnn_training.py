                ...
                for c in clusters:
                    for h in hs:
                        ...
                        parameters = pd.read_csv(
                            "hyperparams/" + type + "/" + model + "-w288-h2.csv"
                        ).iloc[0]
                        ...
                        p = {
                            ...
                            "first_conv_activation": parameters[
                        ...
                        for it in range(ITERATIONS):
                            ...
                            if tuning:
                                for i in range(
                                    int(ds.X_test.shape[0] / tuning_rate) - 1
                                ):
                                    train_model, history, tuning_time = (
                                        predictor.tuning(
                                            ds.X_test[
                                                i * tuning_rate : (i + 1) * tuning_rate
                                            ],
                                            ds.y_test[
                                                i * tuning_rate : (i + 1) * tuning_rate
                                            ],
                            ...
                            train_mean, train_std = predictor.compute_predictions(
                                train_model, ds.X_train, ds.y_train
                            )

                            save_results.save_uncertainty_csv(
                                train_mean,
                                train_std,
                                ds.y_train,
                                "avg" + res,
                            ...
                            if tuning:
                                ...
                                df_inference_time = pd.DataFrame(
                            ...
                            save_results.save_errors(mses, maes, predictor.name)
